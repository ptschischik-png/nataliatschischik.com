  ...
  graph: {
    ...
    '@graph': [
      ...
      },
      {
        ...
        description: 'Hochzeitsfotografie in Kassel, Nordhessen, Göttingen, Marburg, Gießen, Fulda, Paderborn, Hildesheim, Warburg, Bad Hersfeld, Bad Arolsen, Borken, Hofgeismar und darüber hinaus mit dokumentarischen, zeitlosen Reportagen.',
        url: site.url,
