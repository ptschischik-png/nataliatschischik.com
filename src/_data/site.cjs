  ...
  graph: {
    ...
    '@graph': [
      ...
      },
      {
        ...
        description: 'Hochzeitsfotografie in Kassel, Baunatal, Nordhessen, Göttingen, Marburg, Gießen, Fulda, Fritzlar, Frankenberg, Schwalmstadt, Kirchheim, Paderborn, Hildesheim, Northeim, Warburg, Bad Hersfeld, Bad Arolsen, Borken, Hofgeismar und darüber hinaus mit dokumentarischen, zeitlosen Reportagen.',
        url: site.url,
